...
public class EditTreeCommand implements CommandExecutor{
	...
	@Override public boolean onCommand(final CommandSender sender, final Command command, final String label, final String[] arg){
		...
		if(arg.length != 1) {
			final File[] treeFiles = new File(plugin.getDataFolder().getPath()+"/resources/")
