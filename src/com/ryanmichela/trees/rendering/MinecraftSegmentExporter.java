...
import net.arbaro.tree.DefaultStemTraversal;
import net.arbaro.tree.Segment;
import net.arbaro.tree.Subsegment;
...
public class MinecraftSegmentExporter extends DefaultStemTraversal{
	...
	@Override public boolean enterSegment(final Segment s) throws TraversalException{
	...
	@Override public boolean visitSubsegment(final Subsegment subsegment) throws TraversalException{
