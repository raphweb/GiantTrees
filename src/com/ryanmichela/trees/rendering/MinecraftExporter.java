...
import net.arbaro.export.Exporter;
...
public class MinecraftExporter extends Exporter{
	...
	@Override public void write() throws ExportError{
		try{
			// stems
			final MinecraftStemExporter exporter = new MinecraftStemExporter(this.d3d, this.tree.params.stopLevel);
			this.tree.traverseTree(exporter);

			// leaves
			if(this.tree.params.Leaves > 0) {
				final MinecraftLeafExporter lexporter = new MinecraftLeafExporter(this.d3d);
