...
////			drawLine(g,stem.getTransformation().getT(),stem.getMaxPoint().sub(stem.getMinPoint()));
	...
	private void initTransform(Graphics g) throws Exception {
		...
		class FindAStem extends DefaultTreeTraversal {
			...
			@Override public boolean enterStem(Stem stem) {
			...
			@Override public boolean leaveTree(Tree tree) {
				return (found != null);
			}
		}
...
//			System.err.println("dg: "+diag+" dw: "+dw+" minw: "+minw+" dh: "+dh+" minh: "+minh);
	...
	private class LeafDrawer implements TreeTraversal {
		...
		@Override public boolean leaveStem(Stem stem) {
			return true;
		}
...
//				xInt(v.getX()),yInt(v.getZ()));
	...
	private class StemDrawer implements TreeTraversal {
		...
		@Override public boolean enterStem(Stem stem) throws TraversalException {
			stem.traverseStem(
					new StemTraversal() {
						@Override public boolean enterStem(Stem stem) { return true; }
						@Override public boolean leaveStem(Stem stem) { return true; }
						@Override public boolean enterSegment(Segment seg) throws TraversalException {
						...
						@Override public boolean leaveSegment(Segment seg) { return true; }
						@Override public boolean visitSubsegment(Subsegment ss) { return true; }
					}
					);
