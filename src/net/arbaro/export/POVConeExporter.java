...
import net.arbaro.transformation.Matrix;
import net.arbaro.transformation.Transformation;
...
class POVConeLeafExporter implements TreeTraversal {
	 ...
	 */
	@Override public boolean enterStem(Stem stem) throws TraversalException {
		return true;
	}
	 ...
	 */
	@Override public boolean enterTree(Tree tree) throws TraversalException {
		this.tree = tree;
	 ...
	 */
	@Override public boolean leaveStem(Stem stem) throws TraversalException {
		return true;
	}
	 ...
	 */
	@Override public boolean leaveTree(Tree tree) throws TraversalException {
		w.flush();
		return true;
	}
	 ...
	 */
	@Override public boolean visitLeaf(Leaf leaf) throws TraversalException {
...
class POVConeSegmentExporter extends DefaultStemTraversal {
	 ...
	 */
	@Override public boolean enterSegment(Segment s) throws TraversalException {
	 ...
	 */
	@Override public boolean visitSubsegment(Subsegment subsegment)
