...
public class MeshPart extends java.util.Vector {
	 ...
	 * @param section
	 */
	@SuppressWarnings("unchecked") public void addSection(MeshSection section) {
	 ...
	 * @throws MeshError
	 */
	@SuppressWarnings("unchecked") public java.util.Vector faces(long inx, MeshSection section) throws MeshError {
	 ...
	 * @throws MeshError
	 */
	@SuppressWarnings("unchecked") public java.util.Vector vFaces(MeshSection section) throws MeshError {
		MeshSection next = section.next;
		java.util.Vector faces = new java.util.Vector();
...
// this would be easier to use							
	 ...
	 * @throws MeshError
	 */
	@SuppressWarnings("unchecked") public java.util.Vector uvFaces(long inx, MeshSection section, Mesh mesh) throws MeshError {
		MeshSection next = section.next;
		java.util.Vector faces = new java.util.Vector();
		...
		if (section.isFirst()) {
			...
			for (int i=0; i<section.size(); i++) {
				if (useQuads) {
					...
					faces.addElement(new Face(inx+(i+1),ninx+i, ninx+(i+1)));
				}
			}
		}
