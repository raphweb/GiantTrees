...
import net.arbaro.mesh.MeshPart;
import net.arbaro.mesh.MeshSection;
...
public class MeshPartCreator implements StemTraversal {
	 ...
	 */
	@Override public boolean enterSegment(Segment segment) throws TraversalException {
	 ...
	 */
	@Override public boolean leaveSegment(Segment segment) throws TraversalException {
		try {
	 ...
	 */
	@Override public boolean visitSubsegment(Subsegment ss)
